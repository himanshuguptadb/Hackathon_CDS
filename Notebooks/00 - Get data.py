...
# MAGIC 3. Databricks provide multiple Native integrations to load for various sources. For this exercise, we will use **Upload data**. <br>
# MAGIC <img src="https://github.com/himanshuguptadb/Hackathon_CDS/blob/master/Images/Add_Data_Options.png?raw=true" width="1300">
# MAGIC 4. Click on **browse data** to open file browser window. Navigate to the correct folder to load the files. Pick the file you want to create the table for. <br>
...
# MAGIC 6. Click on **create table** button in the bottom left corner of your screen. <br>
